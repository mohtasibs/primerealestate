				...
				<div class="col-xl-5 col-lg-7 col-md-9">
					<div class="authWrap">
						...
						<div class="authbody d-black mb-4">
							<div class="card rounded-4 p-sm-5 p-4">
								<div class="card-body p-0">
									...
									<!-- Title -->
									<div class="text-center"><h1 class="mb-2 fs-2">Welcome To ListingHub!</h1></div>
						...
						<div class="authfooter">
							<div class="text-center"><p class="text-dark mb-0">Are you new here?<a href="{{ url('/register') }}" class="fw-medium text-primary"> Create an account</a></p></div>
						</div>
