...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/css/bootstrap-icons.css') }}?v={{ filemtime(base_path('assets/css/bootstrap-icons.css')) }}">
    <link rel="stylesheet"
    ...
    <!-- GA4 -->
    <script src="https://www.googletagmanager.com/gtag/js?id=G-C3P2LG0HPR" async></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());
        gtag('config', 'G-C3P2LG0HPR');
    </script>
...
<body>
    <!-- GTM noscript -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NXNLY7MK" height="0" width="0"
    ...
    <a href="#" class="btn-primary back-to-top" id="back2Top">
        ...
        try {
            ...
            counters.forEach(c => {
                const updateCount = () => {
                    ...
                    if (inc < 1) inc = 1;
                    if (count < target) {
                        c.innerText = Math.min(count + inc, target).toFixed(0);
