...
@section('title', 'Collinsville, IL')
@section('meta_description', 'Find homes and properties in Collinsville, IL – a charming community with small-town appeal and modern conveniences.')
...
<section class="neighborhood-hero-img position-relative text-white text-center d-flex align-items-center justify-content-center">
    <img src="{{ asset('assets/img/community-8.jpeg') }}"
         alt="Collinsville, IL"
...
<section id="about-neighborhood" class="py-5 bg-light">
    <div class="container">
        <h2 class="fw-bold text-center mb-5">Welcome to Collinsville </h2>
        <div class="row g-4">
            @php
                $ladueImages = [
                    'collinsville-1.jpg',
            ...
            @foreach($ladueImages as $img)
                <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                    <img src="{{ asset('assets/img/' . $img) }}"
                         ...
                         alt=" Collinsville Neighborhood Image"
                         loading="lazy"
...
<section id="featured-properties" class="py-5 bg-light">
    <div class="container">
        ...
        <div id="MBBv3_FeaturedGallery"
             filter="city:collinsville+state:IL+representation_type:any_listing+limit:6+order:price desc">
        </div>
    </div>
</section>
...
<section class="py-5 bg-white">
    <div class="container">
        ...
        <div class="ratio ratio-16x9 rounded shadow">
            <iframe
                src="https://www.google.com/maps/embed/v1/view?key=AIzaSyCFeHHlboPct7Yj6LmMVDcao4R_qlQNTlc&center=38.6703,-89.9846&zoom=13&maptype=roadmap"
