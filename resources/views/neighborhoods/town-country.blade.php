...
@section('title', 'Town & Country')
@section('meta_description', 'Explore elegance in Town & Country – a perfect blend of luxury living and green landscapes.')
...
<section class="neighborhood-hero-img position-relative text-white text-center d-flex align-items-center justify-content-center">
    <img src="{{ asset('assets/img/community-6.avif') }}"
         alt="Town & Country"
    ...
    <div class="container position-relative z-2 py-5">
        ...
        <h1 class="display-4 fw-bold text-white">Town & Country</h1>
        <p class="mb-4 text-white">38.6248° N, 90.4690° W</p>
...
<section id="featured-properties" class="py-5 bg-light">
    <div class="container">
        ...
        <div id="MBBv3_FeaturedGallery"
             filter="mls_id:mo294+city:town and country+representation_type:any_listing+login-panel:false+header-menu:false+limit:3+order:price desc">
        </div>
    </div>
</section>
...
<section class="py-5 bg-white">
    <div class="container">
        ...
        <div class="ratio ratio-16x9 rounded shadow">
            <iframe
                src="https://www.google.com/maps/embed/v1/view?key=AIzaSyCFeHHlboPct7Yj6LmMVDcao4R_qlQNTlc&center=38.6248,-90.4690&zoom=13&maptype=roadmap"
